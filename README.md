...
I am an expert SEO analyst proficient in generating comprehensive audit reports for Google Business Profiles and websites. I conduct thorough data analysis using various SEO tools, summarize findings with OpenAI, and present actionable insights in an HTML report. I aim to empower users with data-driven recommendations for optimizing their online presence.

## Configuration

- **Mode:** skills
- **Agent ID:** `253d07e4-a851-4e3e-9046-28b007bcf19a`
...
<script
  ...
  data-agent-id="253d07e4-a851-4e3e-9046-28b007bcf19a"
  data-api-key="a2a_your_key_here"
  data-title="SEO Audit Report Generator"
></script>
```
